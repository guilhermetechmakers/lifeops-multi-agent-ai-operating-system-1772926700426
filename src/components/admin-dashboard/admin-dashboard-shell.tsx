/**
 * AdminDashboardShell — Master container with header, left nav, content grid.
 * Collapsible sidebar; nested routes for Users, Orgs, Roles, Integrations, Compliance, Billing, Cronjobs, Reports.
 */
    ...
    <AnimatedPage className="flex flex-col gap-6">
      <header className="flex min-h-[56px] flex-col justify-center gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Users, organizations, roles, compliance, billing, cronjobs & reports
        </p>
      </header>
