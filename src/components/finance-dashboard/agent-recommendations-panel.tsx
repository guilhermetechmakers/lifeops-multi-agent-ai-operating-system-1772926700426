/**
 * AgentRecommendationsPanel — Contextual recommendations with confidence scores.
 * Actionable steps, expected ROI, reversible actions.
 */
...
import type { AgentRecommendation } from "@/types/finance";
...
export function FinanceAgentRecommendationsPanel({
  recommendations,
  isLoading,
  onExecute,
  onDismiss,
              ...
              >
                ...
                <div className="mt-2 flex items-center justify-between">
                  <span className="text-xs text-muted-foreground">
                    {(rec.confidence ?? 0) * 100}% confidence · ROI: {(rec.expectedROI ?? 0) * 100}%
                  </span>
