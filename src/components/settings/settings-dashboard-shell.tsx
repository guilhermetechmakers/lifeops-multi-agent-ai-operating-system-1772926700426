/**
 * SettingsDashboardShell — Master container with header, left nav, content.
 * Collapsible sidebar; nested routes for Global, Profile, Integrations, Data & Security, Billing, Exports.
 */
    ...
    <AnimatedPage className="flex flex-col gap-6">
      <header className="flex min-h-[56px] flex-col justify-center gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Notifications, privacy, team & RBAC, integrations, autopilot, data export
        </p>
      </header>
