/**
 * SettingsShell — Master container with header, left nav, content grid.
 * Collapsible sidebar; nested routes for each section.
 */
    ...
    <AnimatedPage className="flex flex-col gap-6">
      <header className="flex min-h-[56px] flex-col justify-center gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Global configuration, notifications, team, integrations, and data
        </p>
      </header>
